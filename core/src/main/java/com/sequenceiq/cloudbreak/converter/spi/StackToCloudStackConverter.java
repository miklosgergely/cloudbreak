...
public class StackToCloudStackConverter {
            ...
            if (instanceGroup.getTemplate() != null) {
                ...
                groups.add(
                        new Group(instanceGroup.getGroupName(),
                                ...
                                buildCloudFileSystemView(cluster.getFileSystem(), componentsByHostGroup, instanceGroup))
                );
            }
        }
        return groups;
    ...
    private Optional<CloudFileSystemView> buildCloudFileSystemView(FileSystem fileSystem, Map<String, Set<String>> componentsByHostGroup, InstanceGroup instanceGroup) {
