...
import static com.sequenceiq.cloudbreak.cloud.azure.view.AzureDatabaseView.DB_VERSION;
import static com.sequenceiq.cloudbreak.cloud.azure.view.AzureDatabaseView.BACKUP_RETENTION_DAYS;
import static com.sequenceiq.cloudbreak.cloud.azure.view.AzureDatabaseView.GEO_REDUNDANT_BACKUP;
import static com.sequenceiq.cloudbreak.cloud.azure.view.AzureDatabaseView.SKU_CAPACITY;
import static com.sequenceiq.cloudbreak.cloud.azure.view.AzureDatabaseView.SKU_FAMILY;
import static com.sequenceiq.cloudbreak.cloud.azure.view.AzureDatabaseView.SKU_TIER;
import static com.sequenceiq.cloudbreak.cloud.azure.view.AzureDatabaseView.STORAGE_AUTO_GROW;
...
public class AzureDatabaseViewTest {

    @Mock(answer = Answers.RETURNS_DEEP_STUBS)
    private DatabaseServer server;

    private AzureDatabaseView underTest;

    @Before
    public void setUp() {
        initMocks(this);

        underTest = new AzureDatabaseView(server);
    }
